package com.living.pullplay.play.tool.video.gl.gles;
...
public class GLRender {
    ...
    private Runnable runnableDrawFrame = () -> doDrawFrame();
    ...
    private void initHandlerThread() {
        if (mGLHandlerThread == null) {
            ...
            mGLHandler = new Handler(mGLHandlerThread.getLooper(), msg -> {
                switch (msg.what) {
